...
public class SlidingPlayerState : IPlayerState
{
    private PlayerStateMachine player;
    private Quaternion originalRotation;
    private Vector3 slopeNormal;

    public SlidingPlayerState(PlayerStateMachine player)
    {
        this.player = player;
    }
    ...
    public void UpdateLogic()
    {
        ...
        {
            player.ChangeState(new JumpPlayerState(player), PlayerStateType.Sliding);
        }
