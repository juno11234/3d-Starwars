...
namespace AmplifyAnimationPack
{
	...
	public class CharacterClass : MonoBehaviour
	{
		...
		private void Awake()
		{
			...
			animBeh = transf.Find( "Mesh" ).GetComponent<CharacterAnimatorBehavior>();
		...
		void GetInputs()
		{
			currState.InputMoveRight( Input.GetAxis( "Horizontal" ) );
			currState.InputMoveForward( Input.GetAxis( "Vertical" ) );
